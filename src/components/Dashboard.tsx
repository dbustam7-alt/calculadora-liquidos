...
export default function Dashboard() {
  ...
  const modules = [
    ...
    },
    {
      ...
      description: 'Guía interactiva paso a paso para ritmos desfibrilables y no desfibrilables, bradicardia, taquicardia inestable, desfibrilación y dosificación de fármacos por peso.',
